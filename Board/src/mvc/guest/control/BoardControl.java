...
import mvc.guest.command.CommandModify2;
import mvc.guest.command.CommandNull;
import mvc.guest.command.CommandView;
...
public class BoardControl extends HttpServlet {
	...
	private void initCommand(){
		...
		commandMap.put("delete-form",new CommandNull("BoardDeleteForm.jsp"));//화면만 보여주면 되서 db를 안타도됨
		...
		commandMap.put("modify-page",new CommandModify2("BoardModify.jsp"));  
